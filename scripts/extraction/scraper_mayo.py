...
OUTPUT_FILE = "test_medical_data_final.json"
...
def scrape_article(article_id):
    ...
    return data
def calculate_expiry_duration(expiry):
    """Calculates the expiry duration of a cookie."""
    if expiry:
...
def main():
    ...
    for i in range(8360, 1000000):  # Run test from 000001 to 000100
        ...
        time.sleep(0.05)  # Avoid overloading the server
